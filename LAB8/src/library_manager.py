class Book:
    ...
    def __eq__(self, other):
        if not isinstance(other, Book):
            return False
        return self.book_id == other.book_id and self.title == other.title and self.author == other.author
...
class LibraryManager:
    ...
    def borrow_book(self, book_id, borrower_id):
        ...
        self.all_borrowers.add(borrower_id)
        return True
    ...
    def get_statistics(self):
        ...
        # Zwracamy liczbę wypożyczających jako liczbę wszystkich osób, które kiedykolwiek wypożyczyły książkę
        return {
            "total_books": total_books,
            "available_books": available_count,
            "borrowed_books": borrowed_count,
            "borrowers_count": len(self.all_borrowers),
            "genres": genres,
